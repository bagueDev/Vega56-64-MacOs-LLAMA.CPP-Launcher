...
> **Das Binary ist bereits im Projektordner vorhanden!** (`/Volumes/SeagateExpansion/download 2/openCodeTest/egpu-alive`)
...
**Für Linux (Alternative zu egpu-alive):**
```bash
# Powerlimit reduzieren (thermische Stabilität)
echo 145000000 | sudo tee /sys/class/drm/card*/device/power_dpm_state
# Oder: amdgpu-utils nutzen
```
...
- [llama.cpp](https://github.com/ggml-org/llama.cpp) – Das Herzstück
- egpu-alive – Im Projektordner enthalten (Binary + Swift-Code)
- Community für Testing & Feedback ❤️
